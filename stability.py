...
print("--------------------------CRUISE--------------------------------------------")
print("The new lift force generated by the body is",CL(2)[0],"[N]")
print("The new lift force generated by the tail is",CL(2)[1],"[N]")
print("The new lift coefficient generated by the body is",CL(2)[2],"[-]")
print("The new lift coefficient generated by the tail is",CL(2)[3],"[-]")
print("----------------------------------------------------------------------")
...
def long_stat_stab_cruise(): #in the pitching plane
    #check the stability
...
long_stat_stab_cruise()

def long_stat_stab_takeoff(): 
    return 

def long_stat_stab_landing(): 
    return
