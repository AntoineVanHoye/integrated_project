...
def CG_position(i,d): 
    ...
    fus_pos = (l_cabin + l_cockpit)*0.45 #0.2*MAC_fus + y_AC_fus*np.tan(sweep_angle_fus)
...
print("The new lift coefficient generated by the body is",CL(config,fuel,Cm0_fus,Cm0_wing)[2],"[-]")
print("The new lift coefficient generated by the tail is",CL(config,fuel,Cm0_fus,Cm0_wing)[3],"[-]")
print("----------------------------------------------------------------------")
